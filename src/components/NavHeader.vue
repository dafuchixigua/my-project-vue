        ...
        <div class="navbar">
          ...
          <div class="navbar-right-container" style="display: flex;">
            <div class="navbar-menu-container">
              ...
              <a href="javascript:void(0)" class="navbar-link"  v-if="!nickName" @click="toShow">Login</a>
                <a href="javascript:void(0)" class="navbar-link" v-else>{{nickName}}</a>
         ...
         <div class="md-modal modal-msg md-modal-transition"  :class="{'md-show':loginWidget}">
           <div class="md-modal-inner">
             <div class="md-top">
               <div class="md-tittle">Login in</div>
               <button class="md-close" @click="close">Close</button>
             </div>
             <div class="md-content">
               <div class="error-wrap">
                 <span class="error error-show" v-if="errorTip">用户名或密码错误</span>
               </div>
               <ul>
             ...
             <div class="login-wrap ">
               <a href="javascript:;" class="btn-login md-content" @click="login">登录</a>
             </div>
           </div>
         </div>
         <div class="md-overlay" v-if="loginWidget"></div>
      </header>
  ...
  methods: {
    ...
    getCartCount(){
      axios({
        ...
        this.$store.commit("initCount",res.data.result)
      })
    }
  }
}
