              ...
              <li v-for="(item,index) in cartList" :key="index">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascript:;" class="checkbox-btn item-check-btn" :class="{'checked':item.checked=='1'}"  @click="eiitCart('checked',item)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="eiitCart('minus',item)">-</a>
                        <span class="select-ipt">{{item.productNum}}</span>
                        <a class="input-add" @click="eiitCart('add',item)">+</a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascript:;">
                  <span class="checkbox-btn item-check-btn" :class="{'checked':checkAllFlag}" @click="toggleCheckAll">
